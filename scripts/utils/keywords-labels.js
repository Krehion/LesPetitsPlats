function createLabel() {
  ...
  filterButtons.forEach((button) => {
    button.addEventListener("click", function () {
      ...
      if (
        button.classList.contains("dropdown--keywords--container__selected")
      ) {
        // Remove the label if the keyword is already selected
        const activeFilterLabels = document.querySelectorAll(
          ".active-labels--label"
        );
        ...
        button.classList.remove("dropdown--keywords--container__selected");
        button.classList.add("dropdown--keywords--container");
      } else {
        // Create and add the label
        const activeFilterLabel = activeFilterLabelTemplate(keywordText);
        const activeFilterLabelDOM =
          activeFilterLabel.getActiveFilterLabelDOM();
        ...
        button.classList.add("dropdown--keywords--container__selected");
        button.classList.remove("dropdown--keywords--container");
      }
    });
  });
}
...
function deleteLabel() {
  const activeFilterButtons = document.querySelectorAll(
    ".dropdown-ingredients--keywords--container__selected"
  );
